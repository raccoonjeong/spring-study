...
<div className="flex flex-col space-y-2">
  <ExternalLink href="/products/detail/1">/products/detail/1</ExternalLink>
  <ExternalLink href="/products/detail/2">/products/detail/2</ExternalLink>
  <ExternalLink href="/products/detail/3">/products/detail/3</ExternalLink>
</div>
